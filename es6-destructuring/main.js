...
console.log('The title of this book is ' + title + ', the author is ' + author +
...
console.log('The title of this book is ' + title2 + ', the author is ' + author2 +
  ', and the library id is ' + libraryID2 + '.');
